...
$myPicture->drawText(200,25,"PPM ".$year." : CAT6a",array("FontSize"=>18,"Align"=>TEXT_ALIGN_BOTTOMMIDDLE));
...
$D=$D.$year;
mysql_close();
 $myPicture->Render("img/PPMCAT6a".$D.".png");
  echo('<br><br><img src="../pChart/img/PPMCAT6a'.$D.'.png"  alt="Print" style="cursor:pointer;" width="1000" height="600"/>');
?>