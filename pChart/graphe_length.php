...
/* J'indique le chemin où je souhaite que mon image soit créée */
 ...
 $myPicture->Render("img/M".$long.".png");

  echo('<br><br><center><img src="../pChart/img/M'.$long.'.png"  alt="Print" style="cursor:pointer;" width="1500" height="450"  /></center>');
}
?>