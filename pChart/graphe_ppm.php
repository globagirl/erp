...
$myPicture->drawText(200,25,"PPM ".$year." : CAT6",array("FontSize"=>18,"Align"=>TEXT_ALIGN_BOTTOMMIDDLE));
...
$D=$D.$year;
mysql_close();
 $myPicture->Render("img/PPMCAT6".$D.".png");
  echo('<br><br><img src="../pChart/img/PPMCAT6'.$D.'.png"  alt="Print" style="cursor:pointer;" width="1000" height="600"/>');
?>