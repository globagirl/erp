...
$sql= mysql_query("SELECT * FROM produit1 where longueur > '0' and produit='$produit' and categorie LIKE 'CAT 6%'  order by longueur ASC");
...
/* J'indique le chemin où je souhaite que mon image soit créée */
 ...
 $myPicture->Render("img/P".$produit.".png");

  echo('<br><br><center><img src="../pChart/img/P'.$produit.'.png"  alt="Print" style="cursor:pointer;" width="1500" height="450"  /></center>');
}
?>