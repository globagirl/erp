...
function affichePlan(){
 ...
 if(valeur=="s"){
   ...
   req.open("POST", "../php/affichePlanUPM_MLD.php",true);
...
////////////////////////////////////////////////////////////////
function ajoutUPMmolding1(){
	 var valeur1 =document.getElementById("plan").value;
		 var valeur2=document.getElementById("IDupmMLD").value;
 ...
 if(valeur=="s"){
   ...
   req.open("POST", "../php/ajoutUPMmolding1.php",true);
   req.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");                  
