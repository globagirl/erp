...
$.ajax({
        type: 'POST',
        data: 'date1='+d1 +'&date2='+d2+'&recherche='+recherche +'&valeur='+val,
        url: '../php/future_accounting.php',
...
function excelProfit(){
	document.form1.action="../php/excel_future_accounting.php";
    document.form1.submit(); 
}
//Print Invoice
function printProfit(){
	document.form1.action="../tcpdf/print_future_accounting.php";
    document.form1.submit(); 
}			   
</SCRIPT> 
</head>
...
<p class="there">Future orders (Not shipped yet) </p>
