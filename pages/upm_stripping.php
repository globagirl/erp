...
<div id='contenu'>
<br>
<p class="there"> Stripping > END </p>
<br>



<form  name="pro_decoup" method="post" action="../php/upm_stripping.php">
 <?php 
		  include('../connexion/connexionDB.php');
						  $numA=$_SESSION['IDupmSTR'];
						  $sql33 = mysql_query("SELECT * FROM upm_stripping where id_str='$numA'");
...
<tr>
                   ...
                   <tr>      <TH colspan=4 WIDTH=150 HEIGHT=30  ALIGN="left"> Type de REBUT :</TH> </tr>
                          
                        
         <tr>
		 <td colspan=2> <input type="checkbox" name="option1"  id="lgn" onclick="a1(this.checked)" > No Stripping <br> </td>
                         <td  WIDTH=10 HEIGHT=30 colspan=2 ALIGN="left"><input type="text" name="no_stripping" id= "qd1" SIZE="8" MAXLENGTH="2"> </td>
         ...
         <tr>
						 <td colspan=2> <input type="checkbox" name="option2" id="denud" onclick="a2(this.checked)" > Brush aspect </td>
                         <td WIDTH=100 colspan=2 HEIGHT=30  ALIGN="left"><input type="text" name="brush" id= "qd2" SIZE="8" MAXLENGTH="8">  </td>
						 
                         
         </tr>
		   <tr>
						 <td colspan=2> <input type="checkbox" name="option2" id="denud" onclick="a2(this.checked)" > Stripping length </td>
                         <td WIDTH=100 HEIGHT=30  colspan=2 ALIGN="left"><input type="text" name="stripping_length" id= "qd2" SIZE="8" MAXLENGTH="8">  </td>
     ...
     <tr>  
  <td colspan=4>
  <input type="submit" id="submitbutton"></td></tr>
