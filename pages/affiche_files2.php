...
<div class="container">
   ...
   <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">UPM3 files</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
...
<thead style="width:100%">
	...
	$req5= mysql_query("SELECT * FROM files_UPM3 where dossier='Quality'");
	$T="files_UPM3";
...
<thead style="width:100%">
	...
	$req5= mysql_query("SELECT * FROM files_UPM3 where dossier='Production'");
	$T="files_UPM3";
   while($a5=@mysql_fetch_object($req5))
    {
    $nameF = $a5->nameF;
...
<thead style="width:100%">
	...
	$req5= mysql_query("SELECT * FROM files_UPM3 where dossier='Logistic'");
	$T="files_UPM3";
   while($a5=@mysql_fetch_object($req5))
    {
    $nameF = $a5->nameF;
...
<thead style="width:100%">
	...
	$req5= mysql_query("SELECT * FROM files_UPM3 where dossier='Direction'");
	$T="files_UPM3";
   while($a5=@mysql_fetch_object($req5))
    {
    $nameF = $a5->nameF;
...
<thead style="width:100%">
	...
	$req5= mysql_query("SELECT * FROM files_UPM3 where dossier='Commercial'");
	$T="files_UPM3";
   while($a5=@mysql_fetch_object($req5))
    {
    $nameF = $a5->nameF;
...
<thead style="width:100%">
	...
	$req5= mysql_query("SELECT * FROM files_UPM3 where dossier='Maintenance'");
	$T="files_UPM3";
   while($a5=@mysql_fetch_object($req5))
    {
    $nameF = $a5->nameF;
...
<thead style="width:100%">
	...
	$req5= mysql_query("SELECT * FROM files_UPM3 where dossier='GRH'");
	$T="files_UPM3";
   while($a5=@mysql_fetch_object($req5))
    {
    $nameF = $a5->nameF;
...
<thead style="width:100%">
	...
	$req5= mysql_query("SELECT * FROM files_UPM3 where dossier='IT'");
	$T="files_UPM3";
   while($a5=@mysql_fetch_object($req5))
    {
    $nameF = $a5->nameF;
