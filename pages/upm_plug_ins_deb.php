...
function affichePlan(){
 ...
 if(valeur==""){
   ...
   req.open("POST", "../php/affichePlanUPM_PLG.php",true);
...
////////////////////////////////////////////////////////////////
function ajoutUPMplug1(){
	
		// var liste1 = document.getElementById("plan");
         var valeur1 = document.getElementById("plan").value;
		 var valeur2=document.getElementById("IDupmPLG").value;
 ...
 if(valeur=="s"){
   ...
   req.open("POST", "../php/ajoutUPMplug1.php",true);
   req.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");                  
...
<p class="there">Plug Insertion</p>
