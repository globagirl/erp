    ...
    <script>
        ...
        function verifierProduit(P,Q,PU,PT){
            ...
            $.ajax({
                ...
                success: function(data) {
                    if(data==0 ){
                        if(v2==0){
                            alert("The product does not exist, please add a new product!!");
                        }
        ...
        function verifierPO(){
            ...
            if( x > -1){
                ...
                $.ajax({
                    ...
                    success:function(data){
                        if(data=="0"){
                            alert("This PO already exists, please check your values !!");
                            document.getElementById('PO').style.backgroundColor='pink';
                            //v=0;
                        }else{
        ...
        function verifier(){
            ...
            if(val==""){
                ...
                alert("PLZ Add Customer !!");
                document.getElementById('client').style.backgroundColor='pink';
                V=1;
            }else if(val5==""){
                alert("PLZ Enter the date requested by the customer !!");
                document.getElementById('dateD').style.backgroundColor='pink';
            }else if(val6==""){
                alert("PLZ Enter the confirmed shipment date!!");
                ...
                alert("PLZ Enter the Total QTY !!");
                document.getElementById('totalQ').style.backgroundColor='pink';
            } else  if(val8==0){
                alert("PLZ Calculate the total price !!");
            ...
            <table>
                <tr>
                    ...
                    <td colspan="4"><input type="text" id="PO" name="po" SIZE="20" onBlur="verifierPO();">
                        <input type="checkbox" name="chek" id="chek"  value="oui" onclick="autoPO();">Don't pass through the production steps
                    </td>
                </tr>
                <tr>
                    <th >UPC: </th>
                    <td colspan="4"><input type="text" id="UPC" name="UPC" SIZE="20" placeholder="UPC customer " >
                ...
                <tr>
                    <th> Date requested by the Customer: </th>
                    <td colspan=4 ><input type="date" name="date_dem_clt" id="dateD"></td>
                </tr>
                <tr>
                    <th>Confirmed shipment date by STARZ: </th>
                ...
                <tr id="TRF">
                    ...
                    <td>
                        <input type="button" id="submitbutton" onclick="verifier()" value="ADD">
                    </td>
                </tr>
            </table>
        </form>
