		...
		<script>
          ...
          $.ajax({
              type: 'POST',
					    ...
					    url: '../php/consult_demande_devis.php',
			...
			function print_demande(numD){
                $.ajax({
                   type: 'POST',
				           data: 'IDdevis='+numD,
				           url: '../tcpdf/demande_devis2.php',
				           success: function(data) {
				              document.location.href="../tcpdf/demande_devis2.php";
                   }});
      }
			    ...
			    <div id="page-wrapper">
					...
					<div class="row">
                       ...
                       <div class="table-responsive col-lg-12" id="divRel">
                               ...
                               <th style="width:29.8%;height:60px" class="degraD">Client</th>
                               <th style="width:24.8%;height:60px" class="degraD">Produit</th>
                               <th style="width:14.9%;height:60px" class="degraD">Prix unitaire</th>
                               ...
                               <th style="width:9.9%;height:60px" class="degraD"></th>
													...
													<?php
                              $x=0;
                              $req= mysql_query("SELECT * FROM demande_devis_produit LIMIT 200");
