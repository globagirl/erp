...
function addAbsence(){
    ...
    if(date1=="" ||date2=="" ){
      ...
      alert("Les dates du congé doivent étre dans le méme mois !! Veillez insérer le congé sur plusieur partie SVP !!");
   }else if(nbrH==""){
      alert("donnez le nombre d' heure SVP !! ");
   } 
   else{
...
<div class="divAuto2"><ul id="listeP1" ></ul></div>
 ...
 <TR> 
			...
			<h5><input type="radio" name="etat" value="Non justifie" checked> Non justifié</h5>
           <h5> <input type="radio" name="etat" value="Justifie">Justifié</h5>
           <h5> <input type="radio" name="etat" value="Certificat"> Certificat</h5>
			</TD> 
 ...
 <td colspan="2"><input type="button" onclick="addAbsence();" id="add1" value="Submit >> ">
 </Td></tr>
