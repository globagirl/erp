    ...
    <div id='contenu'>
        ...
        <form method="post" action="../Starz1.1/php/admin_ajout_user.php" name='form' >
            <TABLE BORDER="0">
                ...
                <TR>
                    <TH WIDTH=120 HEIGHT=30  ALIGN="left">Password:</TH>
                    <TD><input  type="password" name="pswd" SIZE="20"></TD>
                </TR>
                <TR>
                    <th WIDTH=120 HEIGHT=30  ALIGN="left">Access Permission:</th>
                    <td>
                        <select name="role">
            ...
            <Th HEIGHT=30 ><input type="submit" value="Add User" id="bigbutton">
                <input type="reset" value="Clear" id="bigbutton"></Th>
        </form>
        <?php
        if(!empty($_GET['status']))
        {
            ...
            {echo '<SCRIPT LANGUAGE="JavaScript">alert(\'Server Connexion Error\');</SCRIPT>';}
        }
        ?>
    </div>
</div>
