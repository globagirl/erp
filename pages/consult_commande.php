		...
		<div id='contenu'>
            <div class="container">
			    <div id="page-wrapper">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="page-header">Commande client</h1>
                        </div>           
                    </div>
					<div class="row">
                        <div class="col-md-12">
									    ...
									    <div class="row">
										    <div class="pull-left col-md-8">
                                                ...
                                                <div class="form-group">
                                                    <label>Marge par date expédition</label>
                                                    <div class="form-group form-inline">
                                                 ...
                                                 <div class="form-group">
                                                    <input type="button" onClick="affichePO();" class="btn btn-danger" Value="Consulter >>">
                                                 </div>
                                            </div>
