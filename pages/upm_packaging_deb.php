...
function affichePlan(){
 ...
 if(valeur=="s"){
   ...
   req.open("POST", "../php/affichePlanUPM_PAK.php",true);
...
////////////////////////////////////////////////////////////////
function ajoutUPMpackaging1(){
	
		 var valeur1 =  document.getElementById("plan").value;
		 var valeur2=document.getElementById("IDupmPAK").value;
 ...
 if(valeur==""){
   ...
   req.open("POST", "../php/ajoutUPMpackaging1.php",true);
   req.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");                  
