...
//
function updateAB(I,E){
var val = document.getElementById(I).value;
	$.ajax({
        type: 'POST',
        data: 'ID='+I +'&val='+val ,
        url: '../php/update_absence.php',
        success: function(data) {
...
<div id='contenu'>
<br>
<p class="there">Liste des absences</p>
<br>
...
<td></td>
<td colspan=2>
   <input type="button" id="submitbutton" value=">>" onclick="afficheAbsence()">  
</td>
</tr>
</table>
<div id="div1"> </div>
