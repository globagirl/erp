    ...
    <head>
		...
		<script>
			...
			function afficheFact(){
                ...
                var recherche2 = document.getElementById("recherche2").value;
                ...
                $.ajax({
                    type: 'POST',
					data: 'recherche='+recherche+'&recherche2='+recherche2+'&valeur='+val +'&statut='+statut+'&dateD='+dateD+'&dateF='+dateF ,
									    ...
									    <div class="row">
										    <div class="pull-left col-lg-8">
                                                ...
                                                <div class="form-group">
                                                    <label>Marge par ..</label>
                                                    <div class="form-group form-inline">
                                                    <select class="form-control" name="recherche2" id="recherche2" >
														<option value="date_E"> Date expédition</option>
														<option value="date_pay"> Date payment</option>
													</select>
                                            ...
                                            <div class="table-responsive col-lg-12" id="divRel">
											    <table  class="table table-fixed table-bordered results" id="table3">
													...
													<th style="width:11.8%;height:60px" class="degraD">Client</th>
													<th style="width:11.8%;height:60px" class="degraD">Date expédition</th>
				                  <th style="width:12.8%;height:60px" class="degraD">PO</th>
													<th style="width:12.9%;height:60px" class="degraD">Produit</th>
													<th style="width:7.9%;height:60px" class="degraD">Qty</th>
                          <th style="width:7.9%;height:60px" class="degraD">Prix Unitaire</th>
													<th style="width:9.9%;height:60px" class="degraD">Total</th>
													<th style="width:6.9%;height:60px" class="degraD">Statut</th>
                            ...
                            <td style="width:7%;height:60px;text-align:center;background-color:'.$col.'">'.$statut.'</td>';
