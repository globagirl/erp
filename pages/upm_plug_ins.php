...
<div id='contenu'>
<br>
<p class="there"> Plug Insertion > END </p>
<br>
...
<form  name="pro_decoup" method="post" action="../php/upm_plug_insertion.php">
  <?php 
		  include('../connexion/connexionDB.php');
						  $numA=$_SESSION['IDupmPLG'];
						  $sql33 = mysql_query("SELECT * FROM upm_plug_insertion where id_plg='$numA'");
...
<tr>
                         ...
                         <TH WIDTH=150 HEIGHT=30  ALIGN="left" colspan=4 > Type de REBUT :</TH> 
                               
                    
         <tr>
		 <td colspan=2> <input type="checkbox" name="option1"  id="lgn" onclick="a1(this.checked)" > Contact position problem <br> </td>
                         <td colspan=2 WIDTH=10 HEIGHT=30  ALIGN="left"><input type="text" name="contact" id= "qd1" SIZE="8" MAXLENGTH="2"> </td>
         ...
         <tr>
						 <td colspan=2> <input type="checkbox" name="option2" id="denud" onclick="a2(this.checked)" > Reversed Wire </td>
                         <td WIDTH=100 HEIGHT=30 colspan=2 ALIGN="left"><input type="text" name="reverse_wire" id= "qd2" SIZE="8" MAXLENGTH="8">  </td>
