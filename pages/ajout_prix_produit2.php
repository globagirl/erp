...
if(produit=="s"){
	alert("Selectionez un produit  SVP !!"); 
 }
 else{
...
$(divA).after('<TR id='+D+'><TH >FROM</TH><td><input type="text" id='+mL+' size="8" name='+mL+'></td><th> TO   </th><td> <input id='+mH+' size="8" name='+mH+' type="text"></td><th> PRICE '+i+'  </th><td colspan=2 ><input type="text" id='+p+' name='+p+' size="8"/></td></tr>');
...
function addP(){
	...
	if(mLB != "1"){
		alert("la premiére valeur doit étre égale à 1 !!");
...
<option value="s">---Selectionnz</option>
<?php
