...
var val=document.getElementById("client").value;
          ...
          if(val ==""){
		     alert("Sélectionnez un client SVP !!");
...
<p class="there">Auto-création commande</p>
<br>
<br>
<hr size=2 />
    ...
    <table> 	
		<tr>
			...
			<tr>
				...
				<td>
			        <span class="custom-dropdown custom-dropdown--white custom-dropdown--small">
			        <select name="devise" type="text" class="custom-dropdown__select custom-dropdown__select--white">			  <option value="EUR">EUR</option>
...
{ 
     $status = $_GET['status']; 
     if  ($status=="sent")
	 {echo '<SCRIPT LANGUAGE="JavaScript">alert(\'Commande ajouté avec succès \');</SCRIPT>';
