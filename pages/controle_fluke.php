...
function affichePlan(){
 ...
 if(valeur=="s"){
   ...
   req.open("POST", "../php/affichePlanCF.php",true);
...
////////////////////////////////////////////////////////////////
function ajoutFluke1(){
		 var valeur1 = document.getElementById("plan").value;
		 var valeur2=document.getElementById("idCF").value;
 ...
 if(valeur==""){
   ...
   req.open("POST", "../php/ajoutFluke1.php",true);
   req.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");                  
...
<br>
<p class="there">Contrôle Fluke</p>
