...
<div id="main">
    <div id="contenu">
        ...
        <p class="there">Add Quality Agent</p>
        <br>
        <!-- end -->
        ...
        <form method="post" name="form1"  >
            <TR>
                <TD>
                    <input onclick="pop_up('../pages/afich_pers.php');" type="button" value="Afficher personnel" id="bigbutton"><br>
                </TD>
                <br>
                <br><br>
        ...
        <form method="post" action="../php/ajout_ag_qual.php">
            <TABLE BORDER="0">
                <TH HEIGHT=30 colspan="2" bgcolor="#F0E68C" >
                    ...
                    <TR>
                        <Th WIDTH=30 HEIGHT=30 ALIGN="left">First Name</Th>
                        <Td>
                            <?php
                    ...
                    <TR>
                        ...
                        <TD colspan="3">
                            <select name="tache">
                                <option selected="selected" value="cont_assem">Assembly Control</option>
                                <option value="cont_serti">Crimping Control</option>
                                <option value="test">Test</option>
                                <option value="emballage">Packaging</option>
                            </select>
                        </Td>
                    </TR>
            </TABLE>
