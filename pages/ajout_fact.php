...
<div id="main">
    ...
    <div id='contenu'>
        <br>
        <p class="there">Create Invoice</p>
        <br>
        <TABLE BORDER="0">
            <form method="post" name="form1" >
                <input onclick="pop_up('../pages/pop_consult_BL.php');" type="button" value="Consult BL" id="bigbutton"><br>
                <tr>
                    <th>Shipment Date</th>
                    <td><input type="date" name="date_fact" SIZE="20" MAXLENGTH="20"></td>
                    <td><input type="submit" value="Next" id="submitbutton"></td>
                </tr>
            </form>
            ...
            <form method="post" name="form2" action="../php/ajout_fact.php">
			  ...
			  <span class="custom-dropdown custom-dropdown--white custom-dropdown--small">
			    <select name="tpay" id="tpay" type="text" class="custom-dropdown__select custom-dropdown__select--white">	
                    ...
                    <td>
			        <span class="custom-dropdown custom-dropdown--white custom-dropdown--small">
			        <select name="devise" id="devise" type="text" class="custom-dropdown__select custom-dropdown__select--white">
                ...
                <tr>
                    <td></td>
                    <td><input type="submit" value="VALID" id="submitbutton"></td>
                    <td colspan="5"> </td>
                </tr>
            </form>
        </TABLE>
        ...
        if(!empty($_GET['status']))
        {
            $status = $_GET['status'];
            if  ($status=="sent")
            {echo '<SCRIPT LANGUAGE="JavaScript">alert(\'Invoices Added Successfully\');</SCRIPT>';
                //header('Location: ../pages/ajout_fact.php');
            } else if ($status=="fail1"){
                echo '<SCRIPT LANGUAGE="JavaScript">alert(\'Server connection error\');</SCRIPT>';}
            else if ($status=="fail2") {
                echo '<SCRIPT LANGUAGE="JavaScript">alert(\'Data connection error\');</SCRIPT>';
            }else if ($status=="fail") {
                echo '<SCRIPT LANGUAGE="JavaScript">alert(\'BL already billed\');</SCRIPT>';
            }
        }
        ?>
    </div>
