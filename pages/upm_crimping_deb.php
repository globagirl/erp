...
function affichePlan(){
 ...
 if(valeur=="s"){
   ...
   req.open("POST", "../php/affichePlanUPM_CRI.php",true);
...
////////////////////////////////////////////////////////////////
function ajoutUPMcrimping1(){
		  var valeur1 =  document.getElementById("plan").value;
		 var valeur2=document.getElementById("IDupmCRI").value;
 ...
 if(valeur=="s"){
   ...
   req.open("POST", "../php/ajoutUPMcrimping1.php",true);
   req.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");                  
