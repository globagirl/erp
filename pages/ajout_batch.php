...
// var valeur = liste.options[liste.selectedIndex].value;
        ...
        function goo(){
            ...
            if(elem.hasChildNodes()){
                ...
                alert("PLZ select a receipt number !!");
            }
        }
    </script>
</head>
...
<div id="main">
    ...
    <div id='contenu'>
        ...
        <form method="post"  id="form1">
            <TABLE >
                <TR>
                    <Th Wcode_articleTH=150 HEIGHT=30  ALIGN="left" >Reception N°: </Th>
                    <TD colspan="4">
                        <input type="text" name="reception" id="reception" size="20"/>
                        <input type="button" onclick="affiche_paquet()" id="submitbutton" value=">>">
                    </TD>
                </TR>
                <tr>
                    <TH Wcode_articleTH=100 HEIGHT=30  ALIGN="left" colspan="7" style="text-align:center">Packets:  </TH>
                </tr>
                <tr>
            ...
            <input type="button" onclick="goo()" id="submitbutton" value="Submit">
    </div>
</div>
</body>
</html>