...
<head>
    ...
    <title>RG45 Files</title>
    <SCRIPT>
        function deleteFile(f,t){
            if(confirm("Do yu really want to delete this file ?")){
                                ...
                                <form  id="form1" name="form1">
                                    ...
                                    <div class="col-lg-12" id="divRel">
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li onClick="afficheTT();"><a href="#GRH" data-toggle="tab" >Human Resource</a></li>
                                                        ...
                                                        <table class="table table-fixed  results tabScroll">
                                                            ...
                                                            while($a5=@mysql_fetch_object($req5))
                                                            {
                                                                ...
                                                                echo('<tr class='.$x.'><td style="width:30%;height:60px">'.$nameF.'</td>
                                                                    ...
                                                                    ');
                                                                echo ("<td style=\"text-align:center;width:5%;height:60px\"><a href=\"#\" onClick=deleteFile('".$nF."','".$T."'); >
                                                                    <img src=\"../image/deleteFile.png\" alt=\"Log Out\" width=\"30\" height=\"30\"></a></td>
                                                                    </tr>");
                                                            }
                                                            ?>
                                                            </tbody>
