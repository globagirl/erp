...
<TR>		 
  ...
  <Th WIDTH=30 HEIGHT=30 ALIGN="left">Tache </Th> 
			...
			<TD colspan="3">
<select name="tache">
<option selected="selected" value="pince">pince</option>
<option value="test">test</option>
<option value="decoup">machine découpage</option>
<option value="sertissage">machine sertissage</option>
