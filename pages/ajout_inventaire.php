...
function afficheArticle(){		
    ...
    var dateI = document.getElementById("dateI").value;
    if(article==""){
        bootbox.alert("Donnez le code article  SVP !!");
    }else{	
	$.ajax({
	...
	$.ajax({
		...
		success:function(data){
            ...
            if(data=="1"){
                ...
                //afficheListe();
                bootbox.alert("La marge de la différence entre les deux stock est dépassé !! Vérifier vos valeurs SVP!!");
            }else{
                //afficheListe();
                bootbox.alert("Cet article existe déja dans la liste des inventaires !!");
            }
                    ...
                    <div class="row">
                        <div class="col-lg-6">
						    ...
						    <div class="form-group form-inline" id="divA" style="visibility:hidden">
								...
								<input class="form-control" type="text" id="article" placeholder="Code Article" onBlur="hideListe('listeC1');"  onKeyup="autoComplete('article','listeC1');" onFocus="autoComplete('article','listeC1');">
