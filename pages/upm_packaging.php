...
<form  name="pro_decoup" method="post" action="../php/upm_packaging.php">


	  <?php 
		  include('../connexion/connexionDB.php');
						  $numA=$_SESSION['IDupmPAK'];
						  $sql33 = mysql_query("SELECT * FROM upm_packaging where id_pak='$numA'");
...
mysql_close();
        ...
        <TR> 
                         ...
                         <TH WIDTH=150 HEIGHT=30  ALIGN="left" colspan=4> Type de REBUT :</TH> </tr>
                          
         <tr>
		 <td colspan=2> <input type="checkbox" name="option1"  id="lgn" onclick="a1(this.checked)" > Blurred printing of label <br> </td>
                         <td  WIDTH=10 HEIGHT=30 colspan=2 ALIGN="left"><input type="text" name="blurr" id= "qd1" SIZE="8" MAXLENGTH="2"> </td>
         ...
         <tr>
						 <td colspan=2> <input type="checkbox" name="option2" id="denud" onclick="a2(this.checked)" > Misplaced label </td>
                         <td WIDTH=100 HEIGHT=30 colspan=2 ALIGN="left"><input type="text" name="miss" id= "qd2" SIZE="8" MAXLENGTH="8">  </td>
						
                         
         </tr>
		   <tr>
						 <td colspan=2> <input type="checkbox" name="option2" id="denud" onclick="a2(this.checked)" > Box aspect </td>
                         <td WIDTH=100 HEIGHT=30 colspan=2 ALIGN="left"><input type="text" name="box" id= "qd2" SIZE="8" MAXLENGTH="8">  </td>
						
                         
         </tr>
		 <tr>
						 <td colspan=2> <input type="checkbox" name="option2" id="denud" onclick="a2(this.checked)" > Other </td>
                         <td WIDTH=100 HEIGHT=30  ALIGN="left" colspan=2><input type="text" name="other" id= "qd2" SIZE="8" MAXLENGTH="8">  </td>
   ...
   <tr><td colspan="4">
  <input type="submit" id="submitbutton" value="Close"></td></tr>
