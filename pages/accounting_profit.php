                ...
                <div class="row">
                    <div class="col-lg-12" >
                        <div class="panel panel-default">
                            <div class="panel-heading">Consult Accounting Profits</div>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group">
                                                    <div class="radio-inline">
                                                        <label>
                                                            <input type="radio" name="R2" id="ALL" value="ALL" checked>ALL
                                                        </label>
                                                    </div>
                                                    <div class="radio-inline">
                                                        <label>
                                                            <input type="radio" name="R2" id="shipped" value="shipped">Shipped
                                                        </label>
                                                    </div>
                                                    <div class="radio-inline">
                                                        <label>
                                                            <input type="radio" name="R2" id="shippedNot" value="shippedNot">Not Shipped yet
                                                        </label>
                                                    </div>
                                                </div>
