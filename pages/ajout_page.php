...
<head>
    ...
    <script>
        ...
        function addZone(){
            ...
            var Q="Q"+i;
            var D="D"+i;
            $(Z2).after('<div class="col-lg-12" id='+Z+'><div class="form-group col-lg-2"><label>Expected Date </label><input class="form-control" type="date" name='+D+'></div><div class="form-group col-lg-2"> <label>Quantity</label> <input class="form-control" name='+Q+'></div></div>');
        }
        ///DELTE ITEM
        function deleteZone(){
            if(i>1){
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <p class="help-block">Example:new_page.php</p>
                                    </div>
