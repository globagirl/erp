...
function verifierL(){
  ...
  $.ajax({
        ...
        success: function(R) {
          if(R=="0"){
			      bootbox.alert("Cette longueur n'exite pas , veillez l'ajouter SVP !!");
...
function verif_produit(){
  ...
  $.ajax({
        ...
        success: function(R) {
          if(R=="1"){
			      bootbox.alert("Produit existe déja !!");
          }
  }});
} 
...
/*function afficheL(){		
  ...
  function verifier(){	
    ...
    if(prd==""){
	    alert("Donnez le code produit svp !!");		
	  }else  if(IDprd==""){
		  alert("Donnez le code produit svp !!");	
    }else if(desc==""){
		...
		alert("Selectionnez une catégorie SVP  !!");
    }else if(long==""){
		alert("Donner la longueur Produit SVP !!");
