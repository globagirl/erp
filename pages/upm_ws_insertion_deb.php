...
function affichePlan(){
 ...
 if(valeur==""){
   ...
   req.open("POST", "../php/affichePlanUPM_WSI.php",true);
...
////////////////////////////////////////////////////////////////
function ajoutUPMinsertion1(){
	
		 var valeur1 = document.getElementById("plan").value;
		 var valeur2=document.getElementById("IDupmWSI").value;
 ...
 if(valeur=="s"){
   ...
   req.open("POST", "../php/ajoutUPMinsertion1.php",true);
   req.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");                  
...
<p class="there">Wire seal Insertion</p>
