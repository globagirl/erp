		...
		<script>
			...
			function affichePC(){
                ...
                $.ajax({
                    ...
                    url: '../php/consult_payment_client.php',
                    success: function(data) {
                        $('#tbody2').html(data);
                }});
            ...
            function affichePayInfo(i){
			    $.ajax({
                    type: 'POST',
					data:'IDpay='+i,
					url: '../pages/consult_payment_info.php',
					success: function(data) {
                        document.location.href="../pages/consult_payment_info.php";
                }});

            }
            function excelPayment(){
	            document.form1.action="../php/excel_consult_payment_client.php";
									    ...
									    <div class="row">
											...
											<div class="col-lg-4">											    
												<div class="form-group pull-right form-inline">
												    <input type="button" onClick="excelPayment();" class="btn btn-danger" Value="Excel">													
												</div>
											</div>
											<br><br><br><br>	
                                            <div class="table-responsive col-lg-12" id="divRel">
											    <table  class="table table-fixed table-bordered results" id="table3">
													...
													<th style="width:19.7%;height:60px" class="degraD">Client</th>
													...
													<?php
                                                    $x=0;
													$req= mysql_query("SELECT * FROM payment_client order by dateP DESC");
