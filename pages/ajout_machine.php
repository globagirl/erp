...
<div id="main">
    <div id="contenu">
        ...
        <div id="globalc">
            <div id="mbmcpebul_wrapper" style="max-width: 450px;">
                <ul id="mbmcpebul_table" class="mbmcpebul_menulist css_menu">
                    <li class="first_button"><div class="buttonbg gradient_button gradient30"style="width: 210px;"><div class="arrow"><a>Machines Management</a></div></div>
                        <ul>
                    ...
                    <li class="last_button"><div class="buttonbg gradient_button gradient30" style="width: 216px;"><div class="arrow"><a>Spare parts Management </a></div></div>
                        <ul>
        ...
        <p class="there">Add Machine</p>
        <br>
        <!-- end -->
        <form method="post" action="../php/ajout_mach.php">
            <TABLE BORDER="0">
                <TR>
                    <Th WIDTH=150 HEIGHT=30  ALIGN="left" >Serial Number: </Th>
                ...
                <TR>
                    <TH WIDTH=150 HEIGHT=30  ALIGN="left">Stat : </TH>
