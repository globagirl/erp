...
<head>
    ...
    <title>Consult Purchase Order</title>
    <script>
        //Auto complete
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading"> Consult Purchase Order </div>
                                    ...
                                    <div class="row">
                                        <div class="well col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="radio-inline">
                                                    <label><input type="radio" name="statut" id="S2" value="waiting">Waiting </label>
                                                </div>
                                                <div class="radio-inline">
                                                    <label><input type="radio" name="statut" id="S3" value="incomplete">Incomplete </label>
                                                </div>
                                                <div class="radio-inline">
                                                    <label><input type="radio" name="statut" id="S4" value="received">Received</label>
                                                </div>
                                            </div>
                                            <div class="form-group form-inline">
                                                <select class="form-control" name="recherche" id="recherche" onChange="updateZone();">
                                                    <option value="IDordre">Order N°</option>
                                                    <option value="IDarticle">Item</option>
                                            ...
                                            <div class="form-group form-inline">
                                                <select class="form-control" name="recherche1" id="recherche1">
                                                    <option value="dateR">Reception Date </option>
                                            ...
                                            <div class="table-responsive" id="divRel">
                                                <table  class="table table-fixed  results" id="table3">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th style="width:18.8%;height:60px;text-align:center">Supplier</th>
                                                        <th style="width:13.8%;height:60px;text-align:center">Item</th>
                                                        <th style="width:9.9%;height:60px;text-align:center">Requested QTY </th>
                                                        <th style="width:9.9%;height:60px;text-align:center">Received QTY</th>
                                                        <th style="width:10%;height:60px;text-align:center">Reception</th>
                                                        <th style="width:9.9%;height:60px;text-align:center">Unity Price</th>
                                                        <th style="width:9.9%;height:60px;text-align:center" >Total</th>
                                                        <th style="width:8.9%;height:60px;text-align:center">Status</th>
                                                    </tr>
                                                    </thead>
