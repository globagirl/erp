...
var valeur = document.getElementById("plan").value;
 if(valeur==""){
   ...
   req.open("POST", "../php/affichePlanUPM_TST.php",true);
...
////////////////////////////////////////////////////////////////
function ajoutUPMtest1(){
	
		 var valeur1 = document.getElementById("plan").value;
		 var valeur2=document.getElementById("IDupmTST").value;
 ...
 if(valeur==""){
   ...
   req.open("POST", "../php/ajoutUPMtest1.php",true);
   req.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");                  
