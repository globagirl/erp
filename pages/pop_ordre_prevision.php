...
var Z="Z"+i;
		...
		var Q="Q"+i;
		var D="D"+i;
$(Z2).after('<div class="col-lg-12" id='+Z+'><hr><div class="form-group col-lg-1"><label>Date prévue</label><input class="form-control" type="date" name='+D+'></div><div class="form-group col-lg-1"> <label>Quantité</label> <input class="form-control" name='+Q+'></div></div>');
...
?>
   ...
   <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Gestion des ordres d'achat</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            ...
            <div class="row">
				...
				<div  class="well well-sm col-lg-12" >
								 <div class="form-group col-lg-2">
                                            ...
                                            <input class="form-control" id="IDordre" name="IDordre" onBlur="listeArticle()" placeholder="Ordre N°" >                                         
										...
										<div class="form-group col-lg-2">
                                            <label>Article</label>
                                                ...
                                                <select class="form-control" id="listeART" name="listeART" onChange="qteDemande()">
