...
<div id='contenu'>
<br>
<p class="two"> Test > END </p>
<br>


<form  name="pro_decoup" method="post" action="../php/upm_test.php">
 <?php 
		  include('../connexion/connexionDB.php');
						  $numA=$_SESSION['IDupmTST'];
						  $sql33 = mysql_query("SELECT * FROM upm_test where id_tst='$numA'");
...
<table>
<tr>
                            <Th WIDTH=150 HEIGHT=30  ALIGN="left" > Quantity Out: </Th> 
                            <Td><input type="text" name="q_sor" id="qte_s" SIZE="8" onblur="myF2(),calc()" onFocus="del2()" ></Td>
		
                           <TH WIDTH=100 HEIGHT=30  ALIGN="left">Nombre de REBUT:</TH> 
		             ...
		             <!-- ligne 7 du tableau-->
                        ...
                        <!-- ligne 8 du tableau-->
                         ...
                         <tr><TH WIDTH=150 HEIGHT=30 colspan=4 ALIGN="left"> Type de REBUT :</TH></tr> 
                            
                      
         <tr>
		 <td colspan=2> <input type="checkbox" name="option1"  id="lgn" onclick="a1(this.checked)" > Polarity <br> </td>
                         <td  WIDTH=10 HEIGHT=30  colspan=2 ALIGN="left"><input type="text" name="polarity" id= "qd1" SIZE="8" MAXLENGTH="2"> </td>
         ...
         <tr>
						 <td colspan=2> <input type="checkbox" name="option2" id="denud" onclick="a2(this.checked)" > Short_circuit </td>
                         <td WIDTH=100 HEIGHT=30 colspan=2 ALIGN="left"><input type="text" name="short_circuit" id= "qd2" SIZE="8" MAXLENGTH="8">  </td>
						
                         
         </tr>
		 <tr>
						 <td colspan=2> <input type="checkbox" name="option2" id="denud" onclick="a2(this.checked)" > Continuity </td>
                         <td WIDTH=100 HEIGHT=30 colspan=2 ALIGN="left"><input type="text" name="continu" id= "qd2" SIZE="8" MAXLENGTH="8">  </td>
						
                         
         </tr>
        <tr>
						 <td colspan=2> <input type="checkbox" name="option2" id="denud" onclick="a2(this.checked)" > HIPOT </td>
                         <td colspan=2 WIDTH=100 HEIGHT=30  ALIGN="left"><input type="text" name="hipot" id= "qd2" SIZE="8" MAXLENGTH="8">  </td>
						
         </tr>
		 <tr>
						 <td colspan=2> <input type="checkbox" name="option2" id="denud" onclick="a2(this.checked)" >Other </td>
                         <td WIDTH=100 HEIGHT=30 colspan=2 ALIGN="left"><input type="text" name="other" id= "qd2" SIZE="8" MAXLENGTH="8">  </td>
  ...
  <td colspan=4> <input type="submit" id="submitbutton" value="Close"></td></tr>
