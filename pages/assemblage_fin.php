...
<p class="there">Assemblage > Fin Opération</p>
<br>
...
<TABLE id="tab2" style="visibility:hidden" BORDER="0"> 
		...
		<TR> 
			              <TH ALIGN="left">Selectionner la chaine : </TH> 
			              <TD colspan="5">
		...
		<TR> 
			              <TH ALIGN="left">Nombre Opérateur pince: *</TH> 
			              <Td colspan=5><input type="text" name="nbr_opr" SIZE="2" ></Td>
		</TR> 
		
		
		 <TR> 
                         <TH WIDTH=150 HEIGHT=20  ALIGN="left"> Opératrice 1 :</TH>
						 <TH WIDTH=150 HEIGHT=20  ALIGN="left"> Opératrice 2 :</TH>
						 <TH WIDTH=150 HEIGHT=20  ALIGN="left"> Opératrice 3 :</TH>
						 <TH WIDTH=150 HEIGHT=20  ALIGN="left"> Opératrice 4 :</TH>
						 <TH WIDTH=150 HEIGHT=20  ALIGN="left"> Opératrice 5 :</TH>
						 <TH WIDTH=150 HEIGHT=20  ALIGN="left"> Opératrice 6 :</TH>
        ...
        <TR> 
                          <TH WIDTH=100 HEIGHT=30  ALIGN="left">Agent Contrôle: *:</TH> 
                          <TD colspan="5">
     ...
     <TR> 
                         <TH WIDTH=100 HEIGHT=30  ALIGN="left" colspan=7> Type de défaut : </TH> 
						
         <tr>
                         <td> <input type="checkbox" name="option1"  id="dnd" onclick="a1(this.checked)" > Dénudage <br> </td>
                         <td  WIDTH=10 HEIGHT=30  ALIGN="left"><input type="text" name="denud" id= "qd1" SIZE="8" MAXLENGTH="2"> </td>
						 <TD colspan="4" >
                            
							  <select name="action" >
                              <option selected="selected" value="A_C_00">CHOISIR</option>
         ...
         <tr>
                         <td> <input type="checkbox" name="option3" value="Dist_pair" onclick="a3(this.checked)"> Distribution paire<br> </td>
		 ...
		 <tr>
                         <td> <input type="checkbox" name="option3" value="Long_Pair" onclick="a4(this.checked)"> Longeur Paire<br> </td>
		 ...
		 <tr>
                         <td> <input type="checkbox" name="option1" value="Denudage"onclick="a5(this.checked)" > Accessoire manquant<br> </td>
