...
function affichePlan(){
 ...
 if(valeur=="s"){
   ...
   req.open("POST", "../php/affichePlanEM.php",true);
...
////////////////////////////////////////////////////////////////
function ajoutEmballage1(){
		 var valeur1 = document.getElementById("plan").value;
		 var valeur2=document.getElementById("IDemb").value;
 ...
 if(valeur=="s"){
   ...
   req.open("POST", "../php/ajoutEmballage1.php",true);
   req.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");                  
