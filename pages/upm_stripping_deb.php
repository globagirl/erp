...
function affichePlan(){
 ...
 if(valeur==""){
   ...
   req.open("POST", "../php/affichePlanUPM_STR.php",true);
...
////////////////////////////////////////////////////////////////
function ajoutUPMstripping1(){
		 var valeur1 = document.getElementById("plan").value;
		 var valeur2=document.getElementById("IDupmSTR").value;
 ...
 if(valeur=="s"){
   ...
   req.open("POST", "../php/ajoutUPMstripping1.php",true);
   req.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");                  
