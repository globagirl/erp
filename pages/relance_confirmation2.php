...
function afficheDemande(){
	 ...
	 $.ajax({
          ...
          url: '../php/relance_afficheConf2.php',
...
<form action="../php/relance_confirmation2.php" method="POST"  id="form1" name="form1">
<table>
...
<?php
  $sql=mysql_query("SELECT * from demande_relance where statut='C1'");
