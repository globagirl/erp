...
<div id='contenu'>
<br>
<p class="there"> Wire seal Insertion > END </p>
<br>
...
<form  name="pro_decoup" method="post" action="../php/upm_ws_insertion.php">


		 <?php 
		  include('../connexion/connexionDB.php');
						  $numA=$_SESSION['IDupmWSI'];
						  $sql33 = mysql_query("SELECT * FROM upm_ws_insertion where id_wsi='$numA'");
...
mysql_close();
		...
		<tr>
		             ...
		             <!-- ligne 7 du tableau-->
                        ...
                        <!-- ligne 8 du tableau-->
                         ...
                         <TH WIDTH=150 HEIGHT=30 colspan=4 ALIGN="left"> Type de REBUT :</TH> 
                            
         <tr>
		 <td colspan=2> <input type="checkbox" name="option1"  id="lgn" onclick="a1(this.checked)" > Wire seal position problem <br> </td>
                         <td colspan=2 WIDTH=10 HEIGHT=30  ALIGN="left"><input type="text" name="pos" id= "qd1" SIZE="8" MAXLENGTH="2"> </td>
						 
         </tr>
		 
		 
         <tr>
						 <td colspan=2> <input type="checkbox" name="option2" id="denud" onclick="a2(this.checked)" > Orientation problem</td>
                         <td WIDTH=100 HEIGHT=30 colspan=2 ALIGN="left"><input type="text" name="orientation" id= "qd2" SIZE="8" MAXLENGTH="8">  </td>
  ...
  <td colspan=4>  <input type="submit" id="submitbutton"></td></tr>
