...
$IDfact=$_POST['IDfact'];
$_SESSION['IDfact']=$IDfact;
}else{
$IDfact=$_SESSION['IDfact'];
}
$pdf->AddPage('P', 'A4');

$sql=@mysql_query("SELECT * FROM facture_echantillon where numFact='$IDfact'");
//
...
<table border="0" cellpadding="2" cellspacing="15">
  <tr style="background-color:#73C2FB;color:#333333;">
    <td width="140" align="center"> <b> Invoice N° </b> </td>
...
$pdf->ln(-8);
$i=1;
 $sq=mysql_query("SELECT * FROM  facture_echantillon_item where IDfact='$IDfact'");
