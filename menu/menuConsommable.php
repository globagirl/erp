<div id='cssmenua' >
    <ul>
        <li><a href='home.php'><span>Consumable</span><div id="Xnote"></div></a></li>
        ...
        <li class='has-sub'><a href='#'><span>Packaging Management </span></a>
            <ul>
                <li><a href='emballage.php'><span>Packaging</span></a>
                <li><a href='emballage_final.php'><span>Final Packaging</span></a></li>
                <li><a href='emballage_carton.php'><span>Box Packaging</span></a></li>
        ...
        <li class='has-sub'><a href='#'><span>Shipment Orders</span></a>
            <ul>
                ...
                <li class='last'><a href='consult_expedition.php'><span>Shipments List</span></a></li>
            </ul>
        </li>
        <li class='has-sub'><a href='#'><span>Delivery Form</span></a>
            <ul>
                <li><a href='ajout_BL.php'><span>Create BL</span></a></li>
                <li><a href='ajout_BL_auto.php'><span>Auto-Create BL</span></a></li>
