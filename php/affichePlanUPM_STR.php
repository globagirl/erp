...
$x=rand(1, 99);
$y=rand(8, 89);
$IDupmSTR=$plan."UPM".$x.$y;
		
echo("<table> <TR>	<Th Wcode_articleTH=150 HEIGHT=30  >N° OF: <input  type=\"text\" id=\"IDupmSTR\" value=\"".$IDupmSTR."\"/  HIDDEN> </Th>
<td>".$data['OF']."</td>
...
<td ALIGN=\"right\" colspan=3>
	 <input type=\"button\" id=\"submitbutton\" value=\"Lancer\" onclick=\"ajoutUPMstripping1()\"/>
</td>	
