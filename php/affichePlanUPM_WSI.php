...
$x=rand(1, 99);
$y=rand(8, 89);
$IDupmWSI=$plan."UPM".$x.$y;
		
echo("<table> <TR>	<Th Wcode_articleTH=150 HEIGHT=30  >N° OF: <input  type=\"text\" id=\"IDupmWSI\" value=\"".$IDupmWSI."\"/  HIDDEN> </Th>
<td>".$data['OF']."</td>
...
<td ALIGN=\"right\" colspan=3>
	 <input type=\"button\" id=\"submitbutton\" value=\"Lancer\" onclick=\"ajoutUPMinsertion1()\"/>
</td>	
