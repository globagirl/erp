...
$x=rand(1, 99);
$y=rand(8, 89);
$IDupmMLD=$plan."UPM".$x.$y;
		
echo("<table> <TR>	<Th Wcode_articleTH=150 HEIGHT=30  >N° OF: <input  type=\"text\" id=\"IDupmMLD\" value=\"".$IDupmMLD."\"/  HIDDEN> </Th>
<td>".$data['OF']."</td>
...
<td ALIGN=\"right\" colspan=3>
	 <input type=\"button\" id=\"submitbutton\" value=\"Lancer\" onclick=\"ajoutUPMmolding1()\"/>
</td>	
