...
die('Error: ' . mysql_error()); 
    header('Location: ../pages/ajout_fournisseur.php?status=fail');
}else{  
     header('Location: ../pages/ajout_fournisseur.php?status=sent');
}
$userid=$_SESSION['userID'];
$req=mysql_query("INSERT INTO historique(user_id,action,tab,ligne,date_heure)VALUES('$userid','add','fournisseur','$nom',NOW())");  
