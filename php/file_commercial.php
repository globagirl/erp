...
$recherche=@$_POST['recherche'];
  if($recherche=="a"){
		if ($valeur==""){
        $req= "SELECT * FROM commercialfiles";
       }else {
        $req= "SELECT * FROM commercialfiles where nameF LIKE '%$valeur%'";
  }}else {
        $req= "SELECT * FROM commercialfiles where dossierF LIKE '%$recherche%'";
     }
  ...
  while($a=mysql_fetch_object($r))
	...
	<td style=\"text-align:center\"> Commercial/$dossierF/ </td>
	<td style=\"text-align:center\"><a href=\"../files/managementFiles/Commercial/".$dossierF."/".$nameF."\"><img src=\"../image/viewFile.png\" alt=\"Log Out\" width=\"30\" height=\"30\"></a> </td>
