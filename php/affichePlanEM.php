...
echo("<table> <TR>	<Th Wcode_articleTH=150 HEIGHT=30  >N° OF: <input  type=\"text\" id=\"IDemb\" value=\"".$IDemb."\"/  HIDDEN> </Th>
<td>".$data['OF']."</td>
...
<td ></td><td colspan=3>
	 <input type=\"button\" id=\"submitbutton\" value=\"Lancer\" onclick=\"ajoutEmballage1()\"/></div>  
</td>	
