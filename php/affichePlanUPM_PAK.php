...
$x=rand(1, 99);
$y=rand(8, 89);
$IDupmPAK=$plan."UPM".$x.$y;
		
echo("<table> <TR>	<Th Wcode_articleTH=150 HEIGHT=30  >N° OF: <input  type=\"text\" id=\"IDupmPAK\" value=\"".$IDupmPAK."\"/  HIDDEN> </Th>
<td>".$data['OF']."</td>
...
<td><input  type=\"text\" size=\"10\" id=\"qtE\" value=\"".$data2['qte_p']."\"></td></tr><tr>
<td></td>
<td ALIGN=\"right\" colspan=3>
	 <input type=\"button\" id=\"submitbutton\" value=\"Lancer\" onclick=\"ajoutUPMpackaging1()\"/>
</td>	
