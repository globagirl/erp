...
header("Content-Disposition: attachment; filename=future_accounting.xls");
...
$req= "SELECT * FROM commande2 where date_exped >= '$date1' and date_exped<= '$date2'";
  ...
  <th style=text-align:center><b>Accounting profit</b></th>
  <th style=text-align:center><b>Profit percentage</b></th>
  ...
  while($a=@mysql_fetch_object($r)){
    ...
    <tr><td colspan=3 style=text-align:right;background-color:#F5A9BC ><b>Total Profits:</b></td><td colspan=3 style=background-color:#F5A9BC><b>'.$totalProfit .' '.$devise.'</b></td></tr>
    <tr><td colspan=3 style=text-align:right;background-color:#FAB6B6 ><b>Profit percentage:</b></td><td colspan=3 style=background-color:#FAB6B6><b> '.$PT2.' %</b></td></tr>
    </thead></table><hr>';
