...
$req= "SELECT * FROM produit1 where $recherche LIKE '%$valeur%'";
}
  ...
  echo'<table><thead><tr><td>Produit</td><td>Description</td><td>Categorie</td>
  ...
  $poids=$a->poids;
	...
	<td><input  type=\"button\"  id=\"bigbutton\" value=\"Articles\" onclick=\"afficheArt('".$produit."');\"></td>
	</tr>";
    }
  echo '</thead></table>';
