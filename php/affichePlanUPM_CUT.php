...
$x=rand(1, 99);
$y=rand(8, 89);
$IDupmCUT=$plan."UPM".$x.$y;
		
echo("<table> <TR>	<Th Wcode_articleTH=150 HEIGHT=30  >N° OF: <input  type=\"text\" id=\"IDupmCUT\" value=\"".$IDupmCUT."\"/  HIDDEN> </Th>
<td>".$data['OF']."</td>
...
<td ></td><td colspan=3>
	 <input type=\"button\" id=\"submitbutton\" value=\"Lancer\" onclick=\"ajoutUPMcutting1()\"/></div>  
</td>	
