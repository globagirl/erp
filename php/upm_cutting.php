...
$sql = "UPDATE upm_cutting SET date_fin='$date_e',qte_s='$q_sor',q_reb='$q_reb',short_cbl='$short_cbl',long_cbl='$long_cbl',
no_striping='$no_striping',cable_aspect='$cable_aspect', striping_length='$striping_length', other='$other' WHERE id_cut='$id'";
if (!mysql_query($sql)) {
