...
}else if (($recherche == "client") or ($recherche == "date_bl")or ($recherche == "num_bl")) {
...
if($req=="x"){
 ...
 $r=mysql_query($req) or die(mysql_error());
  ...
  while($a=mysql_fetch_object($r))
	...
	$po=$a1->PO;
	$qtu=$a1->qty;
    echo"<tr><td>$num_bl</td><td>$clt</td><td>$date_bl</td><td>$po</td><td>$prd</td><td>$qtu</td><td>$nbr</td><td>$etat</td>
