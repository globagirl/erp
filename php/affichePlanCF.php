...
echo("<table> <TR>	<Th Wcode_articleTH=150 HEIGHT=30  >N° OF: <input  type=\"text\" id=\"idCF\" value=\"".$idCF."\"/  HIDDEN> </Th>
<td>".$data['OF']."</td>
...
<Th Wcode_articleTH=150 HEIGHT=30  >Echantillonage 5% :</Th>
<td><input  type=\"text\" size=\"10\" id=\"qtE\" value=\"0\"></td></tr>
<td ></td><td colspan=3>
	 <input type=\"button\" id=\"submitbutton\" value=\"Lancer\" onclick=\"ajoutFluke1()\"/></div>  
</td>	
