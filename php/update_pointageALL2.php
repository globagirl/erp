...
while($a=mysql_fetch_object($r)){
    ...
    //$xR2=$xR;
    $sql=mysql_query("UPDATE personnel_pointage SET heureD='$horaireD',heureF='$horaireF',statut='y', totalM='$xR',etat='$etat',retard='$mnRT',totalMF='$xR2' where matricule='$mat' and dateP='$dateP'");
}
mysql_close();
