...
echo("<table> <TR>	<Th Wcode_articleTH=150 HEIGHT=30  >N° OF: <input  type=\"text\" id=\"IDtp\" value=\"".$IDtp."\"/  HIDDEN> </Th>
<td>".$data['OF']."</td>
...
<td></td><td colspan=3>
	 <input type=\"button\" id=\"submitbutton\" value=\"Lancer\" onclick=\"ajoutTest1()\"/></div>  
</td>	
