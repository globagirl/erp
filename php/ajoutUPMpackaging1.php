...
$n=strpos($valeur,$pos1);
$IDupmPAK=substr($valeur,0,$n); //definir le IDdecoup
$_SESSION['IDupmPAK'] = $IDupmPAK;
$l=strlen($valeur);
$valeur=substr($valeur,$n+1,$l); //mettre a jour la chaine
...
$valeur=substr($valeur,$n+1,$l); //mettre a jour la chaine
 ...
 $sql = mysql_query("INSERT INTO upm_packaging (id_pak,plan,PO,date_debut,qte_e) 
VALUES ('$IDupmPAK','$plan','$PO','$dateH','$qtE')");
