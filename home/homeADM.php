                    ...
                    <div class="col-md-12" >
                        ...
                        echo '
                                <div class="col-md-6">
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel-body scrollDiv" id="chartQ"></div>
                                    </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="panel panel-default ">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <div class="panel250">
                                    <ul class="chat mesOL" id="listeM"></ul>
                                </div>
                                <div class="well sm-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <button class="btn btn-warning btn-sm" id="btn-chat" type="button" onClick="envoiMsg();">Send</button>
                                        </span>
                                    </div>
                                </div>
                            </div>
